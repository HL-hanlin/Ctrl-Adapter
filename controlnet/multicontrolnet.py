"""
This file is mostly copied from diffusers multi-controlnet: https://github.com/huggingface/diffusers/blob/main/src/diffusers/pipelines/controlnet/multicontrolnet.py#L15

Instead of adding output features from multiple controlnets with equal weights, we append these features to a list as return.

You can ctrl+F and search ### to see the place where we make changes
