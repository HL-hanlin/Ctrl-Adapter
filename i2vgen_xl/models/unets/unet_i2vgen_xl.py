...
class I2VGenXLUNet(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    ...
    def forward(
        ...
        ### this part is newly added for controlnet ###
        if down_block_additional_residuals is not None:
            if down_block_additional_residuals[0].dim() == 5:
                down_block_additional_residuals = [rearrange(down_block_res, "b c f h w -> (b f) c h w") for down_block_res in down_block_additional_residuals]
        ...
        ###   this is newly added for controlnet ###
